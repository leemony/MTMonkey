...
extension Monkey {
    ...
    */
    public func addDefaultXCTestPrivateActions() {
        ...
        addXCTestSlipAction(weight: 5) // slip
    ...
    public func addXCTestElementTapAction(weight: Double) {
        addAction(weight: weight) { [weak self] in
            ...
            do {
                ...
                let root:XCUIElement? = application
                if root == nil {
                    return
                }
                
                let points = try? XCTestWDFindElementUtils.filterPoints(underElement: root!)
    ...
    */
    ...
    public func addXCTestSlipAction(weight: Double) {
        addAction(weight: weight) { [weak self] in
